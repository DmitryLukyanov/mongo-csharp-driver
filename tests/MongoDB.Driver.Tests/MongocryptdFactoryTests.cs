...
namespace MongoDB.Driver.Tests
{
    public class MongocryptdFactoryTests
    {
        ...
        [InlineData(null, "", "--idleShutdownTimeoutSecs 60 --logpath nul --logappend", true)]
        [InlineData("{ mongocryptdBypassSpawn : false }", "", "--idleShutdownTimeoutSecs 60 --logpath nul --logappend", true)]
        [InlineData("{ mongocryptdBypassSpawn : false }", "", "--idleShutdownTimeoutSecs 60 --logpath nul --logappend", true)]
        ...
        [InlineData("{ mongocryptdBypassSpawn : false, mongocryptdSpawnPath : 'c:/mgcr.exe' }", "c:/mgcr.exe", "--idleShutdownTimeoutSecs 60 --logpath nul --logappend", true)]
        // args string
        [InlineData("{ mongocryptdSpawnArgs : '--arg1 A --arg2 B' }", "", "--arg1 A --arg2 B --idleShutdownTimeoutSecs 60 --logpath nul --logappend", true)]
        [InlineData("{ mongocryptdSpawnArgs : '--arg1 A --arg2 B --idleShutdownTimeoutSecs 50' }", "", "--arg1 A --arg2 B --idleShutdownTimeoutSecs 50 --logpath nul --logappend", true)]
        ...
        [InlineData("{ mongocryptdSpawnArgs : '--arg1 A --arg2 B --logappend' }", "", "--arg1 A --arg2 B --logappend --idleShutdownTimeoutSecs 60 --logpath nul", true)]
        // args IEnumerable
        [InlineData("{ mongocryptdSpawnArgs : ['arg1 A', 'arg2 B'] }", "", "--arg1 A --arg2 B --idleShutdownTimeoutSecs 60 --logpath nul --logappend", true)]
        [InlineData("{ mongocryptdSpawnArgs : ['arg1 A', 'arg2 B', 'idleShutdownTimeoutSecs 50'] }", "", "--arg1 A --arg2 B --idleShutdownTimeoutSecs 50 --logpath nul --logappend", true)]
        [InlineData("{ mongocryptdSpawnArgs : ['arg1 A', '--arg2 B', '--idleShutdownTimeoutSecs 50'] }", "", "--arg1 A --arg2 B --idleShutdownTimeoutSecs 50 --logpath nul --logappend", true)]
        ...
        [InlineData("{ mongocryptdSpawnArgs : ['arg1 A', 'arg2 B', '--logpath path.txt', '--logappend'] }", "", "--arg1 A --arg2 B --logpath path.txt --logappend --idleShutdownTimeoutSecs 60", true)]
        [InlineData("{ mongocryptdSpawnArgs : ['arg1 A', 'arg2 B', '--logappend'] }", "", "--arg1 A --arg2 B --logappend --idleShutdownTimeoutSecs 60 --logpath nul", true)]
        [InlineData("{ mongocryptdBypassSpawn : false, mongocryptdSpawnArgs : [ '--arg1 A', '--arg2 B', '--idleShutdownTimeoutSecs 50'] }", "", "--arg1 A --arg2 B --idleShutdownTimeoutSecs 50 --logpath nul --logappend", true)]
