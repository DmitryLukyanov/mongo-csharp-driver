...
namespace MongoDB.Bson.Tests.IO
{
    public class JsonWriterTests
    {
        ...
        public void TestBinaryShell(TemporaryGuidRepresentationMode mode)
        {
            mode.Set();
...
#pragma warning restore 618
        ...
        [ProtectGuidRepresentation]
        [ClassData(typeof(TemporaryGuidRepresentationModeTestCases))]
        public void TestBinaryStrict(TemporaryGuidRepresentationMode mode)
        {
            mode.Set();
...
#pragma warning restore 618
        ...
        [ProtectGuidRepresentation]
        [ClassData(typeof(TemporaryGuidRepresentationModeTestCases))]
        public void TestGuid(TemporaryGuidRepresentationMode mode)
        {
            mode.Set();
