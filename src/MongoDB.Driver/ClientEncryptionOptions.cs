...
namespace MongoDB.Driver
{
    ...
    public class ClientEncryptionOptions
    {
        ...
        /// <param name="mongocryptdClient">The mongocryptd client.</param>
        public ClientEncryptionOptions(
            IMongoClient keyVaultClient,
            CollectionNamespace keyVaultNamespace,
            IReadOnlyDictionary<string, IReadOnlyDictionary<string, object>> kmsProviders,
            IMongoClient mongocryptdClient
            )
        {
            ...
            _kmsProviders = Ensure.That(kmsProviders, providers => providers != null && providers.Any(), nameof(kmsProviders), "kmsProviders should have at least one item.");
            _mongocryptdClient = Ensure.IsNotNull(mongocryptdClient, nameof(mongocryptdClient));
        }
