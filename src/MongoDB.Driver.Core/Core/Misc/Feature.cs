...
namespace MongoDB.Driver.Core.Misc
{
    ...
    public class Feature
    {
        ...
        private static readonly HintForWriteOperationsFeature __hintForWriteOperations = new HintForWriteOperationsFeature("HintForWriteOperations", new SemanticVersion(4, 2, 0), lastNotSupportedVersionThatThrows: new SemanticVersion(3, 4, 0));
